...
<div class="auth-page">
    ...
    <div class="auth-brand">
        <div class="auth-brand-logo">
            <div class="logo-icon"><i class="fa fa-hard-hat" aria-hidden="true">&#9881;</i></div>
        ...
        <div class="auth-brand-tagline">
            ...
            <p>Gerencie seus serviços e equipe com praticidade em um só lugar.</p>
        </div>
    </div>
    ...
    <div class="auth-form-panel">
        <div class="auth-form-box">
            ...
            <p class="auth-subtitle">Não tem conta? <a href="/backend/register">Crie uma agora</a></p>

            <form action="/backend/login" method="POST" autocomplete="off">

                <div class="auth-group">
                    <label for="login-email">E-mail</label>
                    <div class="auth-input-wrap">
                        <input id="login-email" type="email" name="email_usuario" placeholder="seu@email.com" required>
                ...
                <div class="auth-group">
                    ...
                    <div class="auth-input-wrap">
                        <input id="login-senha" type="password" name="senha_usuario" placeholder="••••••••" required>
                        <i class="fa fa-lock"></i>
                    </div>
                </div>

                <button type="submit" class="auth-btn">Entrar na conta</button>
            </form>
        </div>
    </div>
